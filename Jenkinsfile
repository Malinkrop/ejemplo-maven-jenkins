...
pipeline {
    ...
    stages {
            ...
            steps {
                script{
                    nexusPublisher nexusInstanceId: 'nexus',
                        nexusRepositoryId: 'maven-usach-artifact',
                        packages: [
                            [$class: 'MavenPackage',
                                mavenAssetList: [
                                    [classifier: '',
        ...
        stage("Paso 7: Descargar Nexus"){
            steps {
                script{
                    sh ' curl -X GET -u admin:P0o9i8u7 "http://nexus:8081/repository/maven-usach-artifact/com/devopsusach2020/DevOpsUsach2020/0.0.1/DevOpsUsach2020-0.0.1.jar" -O'
                }
            }
        }
